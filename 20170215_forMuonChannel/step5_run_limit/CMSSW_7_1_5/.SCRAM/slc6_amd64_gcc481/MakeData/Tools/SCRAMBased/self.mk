...
CalibrationHcalCalibAlgos_ROOTDICT  := LinkDef
...
IOPoolTFileAdaptor_ROOTDICT  := LinkDef
...
IORawDataHcalTBInputService_ROOTDICT  := LinkDef
...
GeneratorInterfaceExternalDecays_EX_USE := $(foreach d, self  FWCore/Concurrency FWCore/ParameterSet FWCore/Utilities FWCore/Framework FWCore/PluginManager heppdt SimGeneral/HepPDTRecord clhep hepmc GeneratorInterface/Core GeneratorInterface/EvtGenInterface GeneratorInterface/PhotosInterface GeneratorInterface/TauolaInterface,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
...
EventFilterUtilitiesPlugins_LOC_USE := self  FWCore/MessageLogger FWCore/ServiceRegistry FWCore/Framework FWCore/Sources IOPool/Streamer EventFilter/Utilities DataFormats/FEDRawData root boost clhep
