...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/cascade/2.2.04-cms5/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/cgal/4.2-cms4/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/charybdis/1.003-cms5/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/classlib/3.1.3-cms4/include
...
ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/dcap/2.47.8-cms/include
dcap_EX_LIB := dcap
...
fastjet-contrib-archive_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/fastjet-contrib/1.009-cms/include
...
fastjet-contrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/fastjet-contrib/1.009-cms/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/fastjet/3.0.3-cms/include
...
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/frontier_client/2.8.10-cms/include
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/geant4/10.00.p01-cms2/include/Geant4
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/hector/1_3_4-cms18/include
...
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/hepmc/2.06.07-cms2/include
...
ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/herwig/6.521-cms5/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/herwigpp/2.7.0a-cms/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/jimmy/4.2-cms5/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/lhapdf/5.9.1-cms/include
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/mctester/1.25.0a-cms18/include
...
ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/pacparser/1.3.1/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/pythia8/185-cms/include
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/rivet/1.8.2-cms6/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/lcg/roofit/5.34.18-cms3/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/lcg/root/5.34.18-cms4/include

ALL_TOOLS      += rootcint
rootcint_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/lcg/root/5.34.18-cms4/cint
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/sherpa/2.1.1/include/SHERPA-MC
sherpa_EX_LIB := SherpaMain ToolsMath ToolsOrg
sherpa_EX_USE := hepmc lhapdf qd blackhat fastjet sqlite

ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/sigcpp/2.2.10-cms2/include/sigc++-2.0
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/tauolapp/1.1.4-cms/include
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/thepeg/1.9.0a-cms/include
...
ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/valgrind/3.9.0-cms3/include
...
ALL_TOOLS      += xz
xz_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc481/external/xz/5.0.3__5.1.2alpha-cms4/include
xz_EX_LIB := lzma
